...
.replaceAll("[PopB]", "&sub5=popb")
.replaceAll("[PopBx]", "&sub5=popbx")
...
.replaceAll("[PopB]", "&subid2=popb")
.replaceAll("[PopBx]", "&subid2=popbx")
...
function repCb() {
document.body.innerHTML = document.body.innerHTML
.replaceAll("[TopB]", "&aff_sub4=topb")
.replaceAll("[PreB]", "&aff_sub4=preb")
.replaceAll("[PopB]", "&aff_sub4=popb")
.replaceAll("[PopBx]", "&aff_sub4=popbx")
.replaceAll("[FixB]", "&aff_sub4=fixb")
.replaceAll("[SecB]", "&aff_sub4=secb")
.replaceAll("[Pkg1]", "&aff_sub4=pkg1")
.replaceAll("[Pkg2]", "&aff_sub4=pkg2")
.replaceAll("[Pkg3]", "&aff_sub4=pkg3")
.replaceAll("[Pkg4]", "&aff_sub4=pkg4")
.replaceAll("[Pkg5]", "&aff_sub4=pkg5")
.replaceAll("[PkgC]", "&aff_sub4=pkgc")
.replaceAll("[TopBm]", "&aff_sub4=topbm")
.replaceAll("[PreBm]", "&aff_sub4=prebm")
.replaceAll("[FixBm]", "&aff_sub4=fixbm")
.replaceAll("[SecBm]", "&aff_sub4=secbm")
.replaceAll("[Pkg1m]", "&aff_sub4=pkg1m")
.replaceAll("[Pkg2m]", "&aff_sub4=pkg2m")
.replaceAll("[Pkg3m]", "&aff_sub4=pkg3m")
.replaceAll("[Pkg4m]", "&aff_sub4=pkg4m")
.replaceAll("[Pkg5m]", "&aff_sub4=pkg5m")
.replaceAll("[PkgCm]", "&aff_sub4=pkgcm")
.replaceAll("[Flag]", "&aff_sub4=flg")
} repCb();
}
